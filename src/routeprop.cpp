...
int getDaylightStatus(double lat, double lon, wxDateTime utcDateTime) {
  ...
  if (lt <= 12.) {
    ...
    //            OCPNMessageDialog md1(gFrame, msg, _("Sunrise Message"),
    //            wxICON_ERROR ); md1.ShowModal();
...
RouteProp* RouteProp::getInstance(wxWindow* parent, wxWindowID id,
...
RouteProp::RouteProp(wxWindow* parent, wxWindowID id, const wxString& caption,
...
void RouteProp::CreateControlsCompact() {
  ...
  m_RouteStartCtl =
      new wxTextCtrl(itemDialog1, ID_TEXTCTRL2, _T(""), wxDefaultPosition,
  ...
  m_TotalDistCtl =
      new wxTextCtrl(itemDialog1, ID_TEXTCTRL3, _T(""), wxDefaultPosition,
                     wxSize(-1, -1), wxTE_READONLY);
  ...
  m_PlanSpeedCtl =
      new wxTextCtrl(itemDialog1, ID_PLANSPEEDCTL, _T(""), wxDefaultPosition,
                     wxSize(150, -1), wxTE_READONLY);
  itemFlexGridSizer6a->Add(
      m_PlanSpeedCtl, 0,
      wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM, 5);

  wxStaticText* itemStaticText12a =
  ...
  m_TimeEnrouteCtl =
      new wxTextCtrl(itemDialog1, ID_TEXTCTRL4, _T(""), wxDefaultPosition,
                     wxSize(-1, -1), wxTE_READONLY);
  ...
  m_StartTimeLabel =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Departure Time"),
                       wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer6a->Add(
      m_StartTimeLabel, 0,
      wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxTOP, 5);
  ...
  m_StartTimeCtl =
      new wxTextCtrl(itemDialog1, ID_STARTTIMECTL, _T(""), wxDefaultPosition,
                     wxSize(-1, -1), wxTE_READONLY);
  ...
  wxStaticText* itemStaticText12b =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Times shown as"),
                       wxDefaultPosition, wxDefaultSize, 0);
  itemBoxSizer2->Add(itemStaticText12b, 0, wxEXPAND | wxALL, 5);

  m_prb_tzUTC = new wxRadioButton(itemDialog1, ID_TIMEZONESEL_UTC, _("UTC"),
                                  wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
  itemBoxSizer2->Add(
      m_prb_tzUTC, 0,
      wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM, 5);
  /*
  m_prb_tzLocal = new wxRadioButton(itemDialog1, ID_TIMEZONESEL_LOCAL, _("Local
  @ PC")); itemBoxSizer2->Add( m_prb_tzLocal, 0, wxALIGN_LEFT |
  wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM,5 );

  Location")); itemBoxSizer2->Add( m_prb_tzLMT, 0, wxALIGN_LEFT |
  wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM,5 );
  */
  ...
  m_staticText1 =
      new wxStaticText(itemDialog1, wxID_ANY, _("Route Calculation Type:"),
                       wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_wpList =
      new wxListCtrl(itemlistWin, ID_LISTCTRL, wxDefaultPosition,
                     wxSize(100, -1), wxLC_REPORT | wxLC_HRULES | wxLC_VRULES);
  ...
  itemBoxSizer16->Add(m_OKButton, 0,
                      wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL | wxALL, 1);
  m_OKButton->SetDefault();

  //      To correct a bug in MSW commctl32, we need to catch column width drag
  //      events, and do a Refresh() Otherwise, the column heading
  //      disappear..... Does no harm for GTK builds, so no need for conditional

  int char_size = GetCharWidth();

  m_wpList->InsertColumn(0, _("Leg"), wxLIST_FORMAT_LEFT, 10);
  m_wpList->InsertColumn(1, _("At Waypoint"), wxLIST_FORMAT_LEFT,
                         char_size * 14);
  ...
  m_wpList->InsertColumn(8, _("Course to steer"), wxLIST_FORMAT_LEFT,
                         char_size * 11);
  m_wpList->InsertColumn(9, _("Tidal Set"), wxLIST_FORMAT_LEFT, char_size * 11);
  m_wpList->InsertColumn(10, _("Tidal Rate"), wxLIST_FORMAT_LEFT,
                         char_size * 10);
...
void RouteProp::CreateControls() {
  ...
  m_RouteNameCtl = new wxTextCtrl(itemDialog1, ID_TEXTCTRL, _T(""),
                                  wxDefaultPosition, wxSize(710, -1), 0);
  itemStaticBoxSizer3->Add(
      m_RouteNameCtl, 0, wxALIGN_LEFT | wxLEFT | wxRIGHT | wxBOTTOM | wxEXPAND,
      5);
  ...
  m_RouteStartCtl = new wxTextCtrl(itemDialog1, ID_TEXTCTRL2, _T(""),
                                   wxDefaultPosition, wxSize(300, -1), 0);
  itemFlexGridSizer6->Add(
      m_RouteStartCtl, 0,
      wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM, 5);

  m_RouteDestCtl = new wxTextCtrl(itemDialog1, ID_TEXTCTRL1, _T(""),
                                  wxDefaultPosition, wxSize(300, -1), 0);
  ...
  wxStaticBox* itemStaticBoxTZ =
      new wxStaticBox(itemDialog1, wxID_ANY, _("Times shown as"));
  wxStaticBoxSizer* itemStaticBoxSizerTZ =
      new wxStaticBoxSizer(itemStaticBoxTZ, wxHORIZONTAL);
  bSizer2->Add(itemStaticBoxSizerTZ, 0, wxEXPAND | wxALL, 5);

  m_prb_tzUTC = new wxRadioButton(itemDialog1, ID_TIMEZONESEL_UTC, _("UTC"),
                                  wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
  itemStaticBoxSizerTZ->Add(
      m_prb_tzUTC, 0,
      wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM, 5);
  /*
  m_prb_tzLocal =
      new wxRadioButton(itemDialog1, ID_TIMEZONESEL_LOCAL, _("Local @ PC"));
  itemStaticBoxSizerTZ->Add(
      m_prb_tzLocal, 0,
      wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM, 5);

  m_prb_tzLMT =
      new wxRadioButton(itemDialog1, ID_TIMEZONESEL_LMT, _("LMT @ Location"));
  itemStaticBoxSizerTZ->Add(
      m_prb_tzLMT, 0,
      wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM, 5);
*/
  m_staticText1 =
      new wxStaticText(itemDialog1, wxID_ANY, _("RouteCalculation Type:"),
                       wxDefaultPosition, wxDefaultSize, 0);
  ...
  //      Create the list control
  m_wpList = new wxListCtrl(
      this, ID_LISTCTRL, wxDefaultPosition, wxSize(-1, -1),
  ...
  //  wxDefaultPosition, wxDefaultSize, 0 );
  // itemBoxSizerAux->Add( m_PrintButton, 0, wxALIGN_LEFT |
  // wxALIGN_CENTER_VERTICAL | wxALL, 3 ); m_PrintButton->Enable( true );
...
bool RouteProp::ShowToolTips() { return TRUE; }

void RouteProp::SetDialogTitle(const wxString& title) { SetTitle(title); }

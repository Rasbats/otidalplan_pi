...
public:
    ...
    void RenderCourse(Position *pos, wxDateTime time, bool MarkAtPolarChange,
                      trdc &dc, PlugIn_ViewPort &vp);
    void RenderWindBarbs(trdc &dc, PlugIn_ViewPort &vp);
    void RenderCurrent(trdc &dc, PlugIn_ViewPort &vp);
...
private:
    ...
    void SetPointColor(trdc &dc, Position *p);
    void DrawLine(Position *p1, Position *p2, trdc &dc, PlugIn_ViewPort &vp);

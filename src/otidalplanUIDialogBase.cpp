...
otidalplanUIDialogBase::otidalplanUIDialogBase(wxWindow* parent, wxWindowID id,
  ...
  sbSizer6 = new wxStaticBoxSizer(
      new wxStaticBox(this, wxID_ANY, _("Tidal Current Data")), wxVERTICAL);

  m_dirPicker1 = new wxDirPickerCtrl(
      sbSizer6->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a folder"),
  ...
  sbSizer4 = new wxStaticBoxSizer(
      new wxStaticBox(this, wxID_ANY, _("Route Calculation")), wxHORIZONTAL);

  wxStaticBoxSizer* sbSizer3;
  sbSizer3 = new wxStaticBoxSizer(
      new wxStaticBox(sbSizer4->GetStaticBox(), wxID_ANY, _("Speed")),
      wxVERTICAL);
  ...
  sbSizer2 = new wxStaticBoxSizer(
      new wxStaticBox(sbSizer3->GetStaticBox(), wxID_ANY, _("Date/Time")),
      wxVERTICAL);
  ...
  sbSizer91 = new wxStaticBoxSizer(
      new wxStaticBox(sbSizer2->GetStaticBox(), wxID_ANY, _("Route")),
      wxVERTICAL);

  m_staticText4 = new wxStaticText(sbSizer91->GetStaticBox(), wxID_ANY,
                                   _("DR/ETA Route Name"), wxDefaultPosition,
                                   wxDefaultSize, 0);
  ...
  m_cbAddRoute = new wxCheckBox(sbSizer91->GetStaticBox(), wxID_ANY,
                                _("Add route and display "), wxDefaultPosition,
                                wxDefaultSize, 0);
  sbSizer91->Add(m_cbAddRoute, 0, wxALL, 5);

  m_cbGPX =
      new wxCheckBox(sbSizer91->GetStaticBox(), wxID_ANY, _("Save as GPX file"),
                     wxDefaultPosition, wxDefaultSize, 0);
  sbSizer91->Add(m_cbGPX, 0, wxALL, 5);

  m_staticText2 = new wxStaticText(sbSizer91->GetStaticBox(), wxID_ANY,
                                   _("Departure Times"), wxDefaultPosition,
                                   wxDefaultSize, 0);
  m_staticText2->Wrap(-1);
  sbSizer91->Add(m_staticText2, 0, wxALL, 5);

  wxString m_choiceDepartureTimesChoices[] = {_("1"), _("2"), _("3"),
                                              _("4"), _("5"), _("6")};
  ...
  m_bCalcDR =
      new wxButton(sbSizer91->GetStaticBox(), wxID_ANY, _("Calculate DR"),
                   wxDefaultPosition, wxDefaultSize, 0);
  sbSizer91->Add(m_bCalcDR, 0, wxALL | wxEXPAND, 5);

  m_staticline1 =
      new wxStaticLine(sbSizer91->GetStaticBox(), wxID_ANY, wxDefaultPosition,
                       wxDefaultSize, wxLI_HORIZONTAL);
  sbSizer91->Add(m_staticline1, 0, wxEXPAND | wxALL, 5);

  m_bCalcETA =
      new wxButton(sbSizer91->GetStaticBox(), wxID_ANY, _("Calculate ETA"),
                   wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText41 = new wxStaticText(sbSizer4->GetStaticBox(), wxID_ANY,
                                    _("Max Dist from leg"), wxDefaultPosition,
                                    wxDefaultSize, 0);
  ...
  m_cMaxDist =
      new wxChoice(sbSizer4->GetStaticBox(), wxID_ANY, wxDefaultPosition,
                   wxDefaultSize, m_cMaxDistNChoices, m_cMaxDistChoices, 0);
  m_cMaxDist->SetSelection(0);
  fgSizer2->Add(m_cMaxDist, 0, wxALL, 5);

  m_stText =
      new wxStaticText(sbSizer4->GetStaticBox(), wxID_ANY, _("Leg Distance"),
                       wxDefaultPosition, wxDefaultSize, 0);
  m_stText->Wrap(-1);
  ...
  m_cLegDist =
      new wxChoice(sbSizer4->GetStaticBox(), wxID_ANY, wxDefaultPosition,
                   wxDefaultSize, m_cLegDistNChoices, m_cLegDistChoices, 0);
  m_cLegDist->SetSelection(0);
  fgSizer2->Add(m_cLegDist, 0, wxALL, 5);

  m_cbAttach =
      new wxCheckBox(sbSizer4->GetStaticBox(), wxID_ANY, _("Show attachments"),
                     wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_buttonAttach =
      new wxButton(sbSizer4->GetStaticBox(), wxID_ANY, _("Attach Currents"),
                   wxDefaultPosition, wxDefaultSize, 0);
  ...
  sbSizer61 = new wxStaticBoxSizer(
      new wxStaticBox(sbSizer4->GetStaticBox(), wxID_ANY, wxEmptyString),
      wxVERTICAL);

  m_cbPlannedSpeed = new wxCheckBox(sbSizer61->GetStaticBox(), wxID_ANY,
                                    _("Use Planned Speeds"), wxDefaultPosition,
                                    wxDefaultSize, 0);
  m_cbPlannedSpeed->SetValue(true);
  m_cbPlannedSpeed->SetBackgroundColour(
      wxSystemSettings::GetColour(wxSYS_COLOUR_WINDOW));

  sbSizer61->Add(m_cbPlannedSpeed, 0, wxALL, 5);

  m_staticText6 = new wxStaticText(
      sbSizer61->GetStaticBox(), wxID_ANY,
      _("If checked the speeds used \nfor the ETA calculations will\ncome from "
  ...
  m_mSummary = new wxMenuItem(m_menu3, wxID_ANY, wxString(_("Summary")),
                              wxEmptyString, wxITEM_CHECK);
  m_menu3->Append(m_mSummary);

  wxMenuItem* m_mNewRoute;
  m_mNewRoute = new wxMenuItem(m_menu3, wxID_ANY, wxString(_("Route Tables")),
                               wxEmptyString, wxITEM_NORMAL);
  m_menu3->Append(m_mNewRoute);

  wxMenuItem* m_mDeleteAllRoutes;
  m_mDeleteAllRoutes =
      new wxMenuItem(m_menu3, wxID_ANY, wxString(_("Delete All Routes")),
                     wxEmptyString, wxITEM_NORMAL);
  ...
  this->Connect(wxEVT_CLOSE_WINDOW,
                wxCloseEventHandler(otidalplanUIDialogBase::OnClose));
  this->Connect(wxEVT_SIZE, wxSizeEventHandler(otidalplanUIDialogBase::OnSize));
  m_bCalcDR->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                     wxCommandEventHandler(otidalplanUIDialogBase::DRCalculate),
                     NULL, this);
  m_bCalcETA->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(otidalplanUIDialogBase::ETACalculate), NULL, this);
  m_buttonAttach->Connect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(otidalplanUIDialogBase::OnAttachCurrents), NULL,
      this);
  m_dirPicker1->Connect(
      wxEVT_COMMAND_DIRPICKER_CHANGED,
      wxFileDirPickerEventHandler(otidalplanUIDialogBase::OnFolderSelChanged),
      NULL, this);
  m_menu3->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(otidalplanUIDialogBase::OnSummary), this,
                m_mSummary->GetId());
  m_menu3->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(otidalplanUIDialogBase::OnShowTables),
                this, m_mNewRoute->GetId());
  m_menu3->Bind(
      wxEVT_COMMAND_MENU_SELECTED,
      wxCommandEventHandler(otidalplanUIDialogBase::OnDeleteAllRoutes), this,
      m_mDeleteAllRoutes->GetId());
  m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(otidalplanUIDialogBase::OnInformation),
                this, m_mInformation->GetId());
  m_mHelp->Bind(wxEVT_COMMAND_MENU_SELECTED,
                wxCommandEventHandler(otidalplanUIDialogBase::OnAbout), this,
                m_mAbout->GetId());
}
...
otidalplanUIDialogBase::~otidalplanUIDialogBase() {
  ...
  this->Disconnect(wxEVT_SIZE,
                   wxSizeEventHandler(otidalplanUIDialogBase::OnSize));
  m_bCalcDR->Disconnect(
      wxEVT_COMMAND_BUTTON_CLICKED,
      wxCommandEventHandler(otidalplanUIDialogBase::DRCalculate), NULL, this);
...
void ConfigurationDialog::OnDelete(wxCommandEvent& event) {
  ...
  for (std::list<TidalRoute>::iterator it =
           pPlugIn->m_potidalplanDialog->m_TidalRoutes.begin();
       it != pPlugIn->m_potidalplanDialog->m_TidalRoutes.end(); it++) {
    if ((*it).Name == rn) {
      pPlugIn->m_potidalplanDialog->m_TidalRoutes.erase(it);
      m_lRoutes->Delete(s);

      pPlugIn->m_potidalplanDialog->SaveXML(
          pPlugIn->m_potidalplanDialog->m_default_configuration_path);
    }
  }
}
...
AboutDialogBase::AboutDialogBase(wxWindow* parent, wxWindowID id,
  ...
  m_staticText135 =
      new wxStaticText(this, wxID_ANY, _("otidalplan Plugin Version"),
                       wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText110 = new wxStaticText(
      this, wxID_ANY,
      _("The otidalplan plugin for opencpn is intended to calculate routes "
